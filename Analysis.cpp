...
bool Analysis::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("StMet_e", 100, 200.0, 2000.0);
  plot_StMet_e = new TH1F("StMet_e", "StMet_e", 100, 200.0, 2000.0);
  
  Manager()->AddHisto("PT_Scalar_leptons_e", 100, 0.0, 600.0);
  plot_PT_Scalar_leptons_e = new TH1F("PT_Scalar_leptons_e", "PT_Scalar_leptons_e", 100, 0.0, 600.0);
  
  Manager()->AddHisto("PT_Vector_leptons_e", 100, 0.0, 600.0);
  plot_PT_Vector_leptons_e = new TH1F("PT_Vector_leptons_e", "PT_Vector_leptons_e", 100, 0.0, 600.0);
  
  Manager()->AddHisto("M_leptons_e", 12, 0.0, 600.0);
  plot_M_leptons_e = new TH1F("M_leptons_e", "M_leptons_e", 12, 0.0, 600.0);
  ...
  Manager()->AddHisto("StMet_mu", 100, 200.0, 2000.0);
  plot_StMet_mu = new TH1F("StMet_mu", "StMet_mu", 100, 200.0, 2000.0);
  
  Manager()->AddHisto("PT_Scalar_leptons_mu", 100, 0.0, 600.0);
  plot_PT_Scalar_leptons_mu = new TH1F("PT_Scalar_leptons_mu", "PT_Scalar_leptons_mu", 100, 0.0, 600.0);
  
  Manager()->AddHisto("PT_Vector_leptons_mu", 100, 0.0, 600.0);
  plot_PT_Vector_leptons_mu = new TH1F("PT_Vector_leptons_mu", "PT_Vector_leptons_mu", 100, 0.0, 600.0);
  
  Manager()->AddHisto("M_leptons_mu", 12, 0.0, 600.0);
  plot_M_leptons_mu = new TH1F("M_leptons_mu", "M_leptons_mu", 12, 0.0, 600.0);
